...
class PhantomUI:
    ...
    def _print_sword_frame(stage="sheathed"):
        ...
        if stage == "sheathed":
            ...
            s5_sub = "   |||    " # Extra length
            s5_col = b
            tip_sub = "    V     " # Tip usually covered? User said "||| only".
                                    # "when covered it should be ||| only"
                                    # Does that mean no tip displayed? Or tip is |||?
                                    # Assuming tip is hidden or just |||.
                                    # Let's use a rounded bottom or just |||?
                                    # "sword length to one more". 
                                    # Standard scabbard has a tip. Let's make it V but colored Brown.
            tip_sub = "    V     "
            tip_col = b
